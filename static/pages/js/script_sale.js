...
(function () {
  ...
  cart.htmlMessage = function () {
    var htmlMessage = this.cloneNode(true);

    var cartInputs = htmlMessage.querySelectorAll("input");
    [].forEach.call(cartInputs, function (cartInput, i, arr) {
      cartInput.parentElement.innerHTML = cartInput.value;
    });

    var rubleTarget = "<span class=\"ruble\">";
    while (~htmlMessage.innerHTML.indexOf(rubleTarget)) {
      var rubleIndex = htmlMessage.innerHTML.indexOf(rubleTarget);
      htmlMessage.innerHTML = htmlMessage.innerHTML.slice(0, rubleIndex) + "руб." + htmlMessage.innerHTML.slice(rubleIndex + rubleTarget.length + 15);
    }

    var cartTitle = htmlMessage.querySelector("h3");
    cartTitle.style.marginBottom = "45px";
    cartTitle.style.textAlign = "center";
    cartTitle.style.fontWeight = "400";
    cartTitle.style.fontSize = "24px";
    cartTitle.style.lineHeight = "42px";

    var cartTables = htmlMessage.querySelectorAll("table");
    [].forEach.call(cartTables, function (cartTable, i, arr) {
      cartTable.style.borderCollapse = "collapse";
      cartTable.style.width = "100%";
      cartTable.style.marginBottom = "35px";

      var cartTableCaption = cartTable.querySelector("caption");
      cartTableCaption.style.padding = "14px 0";
      cartTableCaption.style.backgroundColor = "#e6ebeb";
      cartTableCaption.style.fontWeight = "700";
      cartTableCaption.style.fontSize = "20px";
      cartTableCaption.style.lineHeight = "32px";

      var cartTableHeaders = cartTable.querySelectorAll("th");
      [].forEach.call(cartTableHeaders, function (cartTableHeader, i, arr) {
        cartTableHeader.style.boxSizing = "border-box";
        cartTableHeader.style.height = "40px";
        cartTableHeader.style.borderTop = "1px solid transparent";
        cartTableHeader.style.borderRight = "1px solid transparent";
        cartTableHeader.style.backgroundColor = "#e6ebeb";
        cartTableHeader.style.fontWeight = "400";
        cartTableHeader.style.fontSize = "14px";
        cartTableHeader.style.lineHeight = "32px";

        if (i === 0) {
          cartTableHeader.style.borderLeft = "1px solid #e6ebeb";
        }

        if (i === arr.length - 1) {
          cartTableHeader.style.borderRight = "none";
        }
      });

      var cartTableParameters = cartTable.querySelectorAll("td");
      [].forEach.call(cartTableParameters, function (cartTableParameter, i, arr) {
        cartTableParameter.style.boxSizing = "border-box";
        cartTableParameter.style.height = "50px";
        cartTableParameter.style.border = "1px solid #b5daee";
        cartTableParameter.style.backgroundColor = "#f0f7f7";
        cartTableParameter.style.verticalAlign = "top";
        cartTableParameter.style.textAlign = "center";
        cartTableParameter.style.fontWeight = "700";
        cartTableParameter.style.fontSize = "16px";
        cartTableParameter.style.lineHeight = "50px";
      });
    });

    var cartSum = htmlMessage.querySelector("p:last-of-type");
    cartSum.style.textAlign = "right";
    cartSum.style.fontSize = "26px";
    cartSum.style.lineHeight = "32px";

    var cartSumKey = cartSum.querySelector("span");
    cartSumKey.style.fontWeight = "400";

    var cartSumValue = cartSum.querySelector("span:last-of-type");
    cartSumValue.style.fontWeight = "700";

    return htmlMessage.innerHTML;
  }
  ...
  var deliveryInfoBlockSelf = document.querySelector(".form__info-block--self-delivery");
  deliveryInfoBlockSelf.show = show;
  deliveryInfoBlockSelf.hide = hide;

  var deliveryInfoBlockNotSelf = document.querySelector(".form__info-block--not-self-delivery");
  deliveryInfoBlockNotSelf.show = show;
  deliveryInfoBlockNotSelf.hide = hide;
  ...
  deliveryTypeSelect.onchange = function () {
    ...
    switch (this.options[n].getAttribute("value")) {
      case "Самовывозом":
        addressLabel.hide();
        stationLabel.hide();
        deliveryInfoBlockNotSelf.hide();
        deliveryInfoBlockSelf.show();
        break;
      case "Железной дорогой":
        deliveryInfoBlockSelf.hide();
        addressLabel.hide();
        stationLabel.show();
        deliveryInfoBlockNotSelf.show();
        break;
  ...
  var cartHTML = document.querySelector("textarea[name=\"cart\"]");
  ...
  form.onsubmit = function (e) {
    ...
    cartHTML.innerHTML = cart.htmlMessage();
  }
